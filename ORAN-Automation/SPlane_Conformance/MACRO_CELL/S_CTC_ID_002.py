...
if __name__ == '__main__':
    ...
    try:
        ...
        ssh_client.connect(hostname="192.168.1.10",username=f"{data['Username']}",password=f"{data['password']}")
        ...
        ssh_ob.connect(hostname="192.168.1.10",username=data["root_Username"],password=data["root_password"])
