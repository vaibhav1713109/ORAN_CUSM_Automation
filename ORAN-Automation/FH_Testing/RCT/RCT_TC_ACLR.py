...
def Rct_TC_aclr(test_case_name,eaxid,amplitude,ext_gain):
    DL_data = {}
    try:
        ...
        #     vxt_configuration_status = aclr_control(test_case_name,ext_gain,eaxid)
        ...
        print(f'Rct_TC_aclr Error : {e}')
        return f'Rct_TC_aclr Error : {e}'
...
if __name__ == "__main__":
    try:
        ...
        Result = Rct_TC_aclr(test_case_name,eaxid,amplitude,external_gain)
        print(Result)
    except Exception as e:
        print(f"RCT_TC_ACLR Error : {e}")
        print("Please run by below command :/npython RCT_TC_ACLR.py {test_case_name} {eaxcid} {amplitude} {external_gain}")