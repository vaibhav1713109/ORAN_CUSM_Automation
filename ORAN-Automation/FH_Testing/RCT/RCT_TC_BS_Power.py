...
def Rct_TC_bs_power(test_case_name,eaxid,amplitude,ext_gain):
    DL_data = {}
    try:
        ...
        if 'PRACH' not in test_case_name and 'DL' in test_case_name:
            ...
            vxt_configuration_status = base_station_power(test_case_name,ext_gain,eaxid)
        ...
        print(f'Rct_TC_bs_power Error : {e}')
        return f'Rct_TC_bs_power Error : {e}'
...
if __name__ == "__main__":
    try:
        ...
        Result = Rct_TC_bs_power(test_case_name,eaxid,amplitude,external_gain)
        print(Result)
    except Exception as e:
        print("RCT_TC_BS_Power Error : {e}")
        print("Please run by below command :/npython RCT_TC_BS_Power.py {test_case_name} {eaxcid} {amplitude} {external_gain}")