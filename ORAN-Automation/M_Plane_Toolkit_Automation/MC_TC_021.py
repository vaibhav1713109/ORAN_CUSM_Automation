...
with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    ...
    temp=data["general"]
    x= {"call-flow-xml": ["MC_TC_021.1.xml"], "fail_call_home": "False", "username": "operator", "password": "admin123", "tls-hostname": "operator",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_021.1.log')

with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    data1=json.load(json_file)
    temp=data1["general"]
    x= {"call-flow-xml": ["MC_TC_021.2.xml"], "fail_call_home": "False", "username": "observer", "password": "admin123", "tls-hostname": "observer",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_021.2.log')
