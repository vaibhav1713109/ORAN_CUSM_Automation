...
with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    ...
    temp=data["general"]
    x= {"call-flow-xml": ["MC_TC_020.1.xml"], "fail_call_home": "False", "username": "operator", "password": "admin123", "tls-hostname": "operator",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_020.1.log')

with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    data1=json.load(json_file)
    temp=data1["general"]
    x= {"call-flow-xml": ["MC_TC_020.2.xml"], "fail_call_home": "False", "username": "installer", "password": "wireless123", "tls-hostname": "installer",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_020.2.log')
