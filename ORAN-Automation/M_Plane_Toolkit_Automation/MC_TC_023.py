...
with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    ...
    temp=data["general"]
    x= {"call-flow-xml": ["MC_TC_023.1.xml"], "fail_call_home": "False", "username": "operator", "password": "admin123", "tls-hostname": "operator",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_023.1.log')

with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    data1=json.load(json_file)
    temp=data1["general"]
    x= {"call-flow-xml": ["MC_TC_023.2.xml"], "fail_call_home": "False", "username": "operator97206", "password": "f7^ZKe^czzZlkX].yg43(+AJbcCzqam$z0BYE3)betIDbz98IK{62", "tls-hostname": "operator972061",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_023.2.log')
