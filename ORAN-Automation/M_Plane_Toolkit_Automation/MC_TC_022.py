...
with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    ...
    temp=data["general"]
    x= {"call-flow-xml": ["MC_TC_022.1.xml"], "fail_call_home": "False", "username": "operator", "password": "admin123", "tls-hostname": "operator",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_022.1.log')

with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    data1=json.load(json_file)
    temp=data1["general"]
    x= {"call-flow-xml": ["MC_TC_022.2.xml"], "fail_call_home": "False", "username": "operator7131913", "password": "$C+zr[lT_k+]Xz.BXjvKaZf^Pf}nTUJF}1ClrerB+hL{Lf6U6%J}f", "tls-hostname": "operator71319136",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_022.2.log')
