...
with open ("C:\\ProgramData\\Keysight\\MPlane\\Client\\duprofile\\v2\\client_config.json") as json_file:
    ...
    temp=data["general"]
    x= {"call-flow-xml": ["MC_TC_003.xml"], "fail_call_home": "False", "username": "operator", "password": "adssmin123", "tls-hostname": "operator",}
    temp.update(x)
...
os.rename(latest_file,'MPlane_Toolkit_Logs_003.log')
