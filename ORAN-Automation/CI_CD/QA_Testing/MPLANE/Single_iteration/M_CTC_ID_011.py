...
class M_CTC_ID_011(PDF,Configuration,netopeer_connection,genrate_pdf_report):
    ...
    def Main_Function(self):
        ...
        self.trace_conn = netopeer_connection.start_trace()
    ...
    def api_call(self):
        ...
        Configuration.Result_Declartion(self,'Get_with_filter',Result, 'test',self.trace_conn)
