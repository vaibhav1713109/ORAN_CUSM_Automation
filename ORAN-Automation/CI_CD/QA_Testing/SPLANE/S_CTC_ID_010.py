        ...
        try:
            ...
            with manager.connect(host=host, port=port, username=user, hostkey_verify=False, password=password) as m:
                ...
                if state == "Link" or "Event":
                    ...
                    notification("Waiting for O-RU Synchronization")
                    list1.append("Waiting for O-RU Synchronization")
                    ###########################################################################################################################
                    ...
                    while timeout > time.time():
                        n = m.take_notification(timeout=360)
                        if n == None:
                            break
                    ...
                    ###########################################################################################################################
                    notification("O-RU is Synchronized || Success")
                    list1.append("O-RU is Synchronized || Success")
                    ...
                    pdf.add_page()
                    ###########################################################################################################################
                    #                                             Disable PTP and SyncE                                                       #
                    ###########################################################################################################################
                    STARTUP.STORE_DATA("Disconnect the PTP and SyncE & Capturing Notification",Format = True,PDF = pdf)
                    calnexSet(f"app/generation/synce/esmc/Port{port_num}/stop")
                    calnexSet(f"app/mse/master/Master{port_num}/stop")
                    notification("Disabling PTP and SyncE || Success")
                    list1.append("Disabling PTP and SyncE || Success")
                    c = 0  
                    ...
                    pdf.add_page()
                    ###########################################################################################################################
                    #                                             Retrieving Holdover state of O-RU                                                        #
                    ###########################################################################################################################
                    ...
                    notification("O-RU Freerun State transition || Waiting")
                    list1.append("O-RU Freerun State transition || Waiting")
                    time.sleep(900)
                    ...
                    ###########################################################################################################################
                    #                                             Retrieving Freerun state of O-RU                                                        #
                    ########################################################################################################################### 
...
if __name__ == '__main__':
    ...
    try:
        ...
        ###########################################################################################################################
            ...
            # time.sleep(120)
            # notification("Board rebooted successfully proceeding to next test case")
        ###########################################################################################################################
        #                                              Static ip Code Flow                                                        #
        ###########################################################################################################################
        elif ip_type == "STATIC":
