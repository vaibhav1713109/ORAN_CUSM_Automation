...
def Result_Decleration(host, port, user, password):
    try:
        with manager.connect(host=host, port=port, username=user, hostkey_verify=False, password=password) as m:
            ...
            SyncE_lock_state=dict_Sync1['data']['sync']['synce-status']['lock-state']
            ...
            SyncE_state=dict_Sync1['data']['sync']['synce-status']['sources']['state']
    ...
    try:
        ...
        with manager.connect(host=host, port=port, username=user, hostkey_verify=False, password=password) as m:
            ...
            if state == "Link" or "Event":
                ...
                pdf.add_page()
                ###########################################################################################################################
                #                                         change clock class 140 from paragon                                             #
                ###########################################################################################################################  
                ...
                pdf.add_page()
                ###########################################################################################################################
                #                                         change clock class 150 from paragon                                             #
                ########################################################################################################################### 
                ...
                pdf.add_page()
                ###########################################################################################################################
                #                                         change clock class 160 from paragon                                             #
                ########################################################################################################################### 
