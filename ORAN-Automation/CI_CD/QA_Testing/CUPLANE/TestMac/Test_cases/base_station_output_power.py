...
/**
 *
 * @file     Base_station_output_power.py
 * @part_of  CICD RCT O-RAN CONFORMANCE
...
tc_no = sys.argv[1]
state_file = {"tc4":"TM_1_1.state"}
screen_shot_file = {"tc4":"TM_1_1.png"}
...
if __name__ == "__main__":
    try:
        ...
        Test_procedure = [f"{'='*100}\nTest case *Base_station_output_power.py* Started!! Status: Running\n{'='*100}",'Start Time : {}'.format(start_time),'='*100]
        notification('\n'.join(Test_procedure))
