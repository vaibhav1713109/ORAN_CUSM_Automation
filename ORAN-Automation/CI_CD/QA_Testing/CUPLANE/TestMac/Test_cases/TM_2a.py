...
tc_no = sys.argv[1]
state_file = {"tc5":"TM_2a.state"}
screen_shot_file = {"tc5":"TM_2a.png"}
testmac_path = {"tc5":"runnr 0 1 100 12110"}
log_file1 = {"tc5":"TM2_ch1.txt"}
log_file2 = {"tc5":"TM2_ch2.txt"}
