...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.testCaseUI.submitBtn.clicked.connect(lambda : self.get_all_data_and_run('Test_Suit',self.testCaseUI.consoleEdit))

        ##############################################################################
        ## if clicked on run button on each module widget
        ##############################################################################
        self.ui.runButton.clicked.connect(lambda: self.checked(self.checkboxs_1,self.ui.consoleEdit,self.transport_handshake))
        self.ui.runButton_2.clicked.connect(lambda: self.run_module(['M_CTC_ID_007'],self.ui.consoleEdit_2,self.subscription))
        self.ui.runButton_3.clicked.connect(lambda: self.checked(self.checkboxs_3,self.ui.consoleEdit_3,self.supervision))
        self.ui.runButton_4.clicked.connect(lambda: self.checked(self.checkboxs_4,self.ui.consoleEdit_4,self.ru_info))
        self.ui.runButton_5.clicked.connect(lambda: self.checked(self.checkboxs_5,self.ui.consoleEdit_5,self.fault_mgmt))
        self.ui.runButton_6.clicked.connect(lambda: self.checked(self.checkboxs_6,self.ui.consoleEdit_6,self.sw_mgmt))
        self.ui.runButton_7.clicked.connect(lambda: self.checked(self.checkboxs_7,self.ui.consoleEdit_7,self.access_control))
        self.ui.runButton_8.clicked.connect(lambda: self.checked(self.checkboxs_8,self.ui.consoleEdit_8,self.ru_configure))
        self.ui.runBtn.clicked.connect(lambda: self.run_module(['M_CTC_ID_034'],self.ui.consoleEdit_10,self.log_mgmt))

        ##############################################################################
        ## if clicked on run all button on each module widget
        ##############################################################################
        self.ui.run_89.clicked.connect(lambda: self.run_module(['/Module/module_3'],self.ui.consoleEdit_3,self.supervision))
        self.ui.run_10_11.clicked.connect(lambda: self.run_module(['/Module/module_4'],self.ui.consoleEdit_4,self.ru_info))
        self.ui.run_12_13.clicked.connect(lambda: self.run_module(['/Module/module_5'],self.ui.consoleEdit_5,self.fault_mgmt))
        self.ui.run_14_17.clicked.connect(lambda: self.run_module(['/Module/module_6'],self.ui.consoleEdit_6,self.sw_mgmt))
        self.ui.run_18_23.clicked.connect(lambda: self.run_module(['/Module/module_7'],self.ui.consoleEdit_7,self.access_control))
        self.ui.run_26_27.clicked.connect(lambda: self.run_module(['/Module/module_8'],self.ui.consoleEdit_8,self.ru_configure))
    ...
    def Run_All(self,filename, console):
        ...
        self.p.start("python -m pytest -v", ['{}/require/{}.py'.format(dir_path,filename)])
    ...
    def on_State_change_5(self,state):
        for checkbox in self.checkboxs_5:
    ...
    def on_State_change_6(self,state):
        for checkbox in self.checkboxs_6:
            checkbox.setCheckState(state)
    ...
    def on_State_change_7(self,state):
        for checkbox in self.checkboxs_7:
            checkbox.setCheckState(state)
    ...
    def on_State_change_8(self,state):
        for checkbox in self.checkboxs_8:
            checkbox.setCheckState(state)
