###############################################################################
##@ FILE NAME:      Success file Management Operation retrieval
...
class success_file_retrieve(vlan_Creation):
...
'''
            ...
            if result:
                ...
                STARTUP.ACT_RES(f"{'Success file Management Operation retrieval' : <50}{'=' : ^20}{'FAIL' : ^20}",PDF= pdf_log,COL=(255,0,0))
                return result
                
            else:
                STARTUP.ACT_RES(f"{'Success file Management Operation retrieval' : <50}{'=' : ^20}{'PASS' : ^20}",PDF= pdf_log,COL=(105, 224, 113))
                return True    
...
if __name__ == '__main__':
    try:
        ...
        STARTUP.STORE_DATA(
            f"Error occured in line number {exc_tb.tb_lineno}", Format = False,PDF=pdf_log)
        print('Usage: python success_file_retrieve.py <Test_Case_ID>')
