...
class Ui_CU_HomePage(object):
    def setupUi(self, MainWindow):
        ...
        # DL test Cases
        self.DL_testCases = ['Downlink Base', 'Downlink Extended',
                             'Downlink No Compresssion', 'Downlink 9 Bit', 'Downlink 12 Bit', 'Downlink 14 bit']
        ...
        bandwidths = ('10M', '20M', '30M', '40M', '50M',
                      '60M', '70M', '80M', '100M')
        phase_comps = ('Off', 'On')
        required_info = {'SubCarrier Spacing :': scsvalues, 'Duplex Type :': duplextypes, 'Downlink Frequency :': 'GHz(Eg. 3.6250)', 'Uplink Frequency :': 'GHz(Eg. 3.6250)',
                         'External Gain :': 'dBm(Eg. 22.3)', 'Bandwidths': bandwidths, 'Phase Compensation :': phase_comps, 'VXT Address :': 'TCPIP0::172.17.95.2::inst0::INSTR',
                         'Eaxcid :': 'Space saprated Channel No.', 'Save Result :': 'C:/Result', 'Downlink Timing': None, 'DL C-Plane Timing :': '500000', 'DL U-Plane Timing :': '375000',
                         'C-Plane Time(Tcp_adv_dl) :':'','Uplink Timing :': None, 'UL C-Plane Time(T1a_cp_ul) :':'5000','UL U-Plane Time Delay(Ta3_up_ul) :':'2000'}
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.downlinkLabel.setText(_translate("MainWindow", "Downlink"))
    ...
    def checked_mul(self):
        self.TestCaseData = []
        self.checkboxes = self.Dl_checkboxes+self.ul_CheckBoxes 
