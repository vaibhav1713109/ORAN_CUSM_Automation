...
def band(bands):    
    if(bands == "5M"):
        return OrsConfiguration.Bandwidth.FR1_5M
    if(bands == "10M"):
        return OrsConfiguration.Bandwidth.FR1_10M
    if(bands == "15M"):
        return OrsConfiguration.Bandwidth.FR1_15M
    if(bands == "20M"):
        return OrsConfiguration.Bandwidth.FR1_20M
    if(bands == "25M"):
        return OrsConfiguration.Bandwidth.FR1_25M
    if(bands == "30M"):
        return OrsConfiguration.Bandwidth.FR1_30M
    if(bands == "40M"):
        return OrsConfiguration.Bandwidth.FR1_40M
    if(bands == "50M"):
        return OrsConfiguration.Bandwidth.FR1_50M
    if(bands == "60M"):
        return OrsConfiguration.Bandwidth.FR1_60M
    if(bands == "70M"):
        return OrsConfiguration.Bandwidth.FR1_70M
    if(bands == "80M"):
        return OrsConfiguration.Bandwidth.FR1_80M
    if(bands == "90M"):
        return OrsConfiguration.Bandwidth.FR1_90M
    if(bands == "100M"):
        return OrsConfiguration.Bandwidth.FR1_100M
        

def format_return(formats):    
    if(formats == "0"):
        return OrsConfiguration.PRACH_Format.Format0
    if(formats == "1"):
        return OrsConfiguration.PRACH_Format.Format1
    if(formats == "2"):
        return OrsConfiguration.PRACH_Format.Format2
    if(formats == "3"):
        return OrsConfiguration.PRACH_Format.Format2
    #if(formats == "A0"):
        #return OrsConfiguration.PRACH_Format.FormatA0
    if(formats == "A1"):
        return OrsConfiguration.PRACH_Format.FormatA1
    if(formats == "A2"):
        return OrsConfiguration.PRACH_Format.FormatA2
    if(formats == "A3"):
        return OrsConfiguration.PRACH_Format.FormatA3
    if(formats == "B1"):
        return OrsConfiguration.PRACH_Format.FormatB1
    if(formats == "B2"):
        return OrsConfiguration.PRACH_Format.FormatA2B2
    if(formats == "B3"):
        return OrsConfiguration.PRACH_Format.FormatA3B3
    if(formats == "B4"):
        return OrsConfiguration.PRACH_Format.FormatB4
    if(formats == "C0"):
        return OrsConfiguration.PRACH_Format.FormatC0
    if(formats == "C2"):
        return OrsConfiguration.PRACH_Format.FormatC2
...
def DL(bands, eAxID, sub_folder, bit_width):
    ...
    ret_band = band(bands)
    myConfig.Numerology_RecoverIqFlowBandwidth(ret_band) # Set bandwidth for IQ recovery
...
def DL_UL(bands, eAxID, sub_folder, bit_width):
    print("============================================================================================")
    print("============================ORS CONFIGURATION===============================================")
    print("============================================================================================")
    #Instantiation creates all resources necessary to subsequent API usage
...
def PRACH(bands, eAxID, sub_folder, formats):
    print("============================================================================================")
    print("============================ORS CONFIGURATION===============================================")
    print("============================================================================================")
    #Instantiation creates all resources necessary to subsequent API usage
    ...
    print("- Import Waveform Project (.scp)")
    #The method opens a project file (Signal Studio uses file extension ".scp") previously saved from Keysight Signal Studio. 
    file_name = sub_folder+"\Format"+formats
    file_name_1 = file_name+"\CTC_5GNR.scp"
    myProject = myApi.ImportWaveformProject(file_name_1)
    ...
    ret_format = format_return(formats)
    myConfig.Numerology_PrachPreambleFormat (ret_format)
