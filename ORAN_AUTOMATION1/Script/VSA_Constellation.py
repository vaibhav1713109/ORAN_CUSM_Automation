...
def VSA_Function(sub_folder):
    ...
    if ("Agilent.SA.Vsa.Vector-x64.exe" in (p.name() for p in psutil.process_iter())):
        ...
        os.startfile("C:\Program Files\Keysight\89600 Software 2023_U1\89600 VSA Software\Agilent.SA.Vsa.Vector-x64.exe")
        time.sleep(30)
    ...
    orb_filename = sub_folder+"\CTC_5GNR_recovered_iq.1_mu1_ant1.iqt.orb"
